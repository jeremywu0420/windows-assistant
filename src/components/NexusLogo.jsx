...
function NexusMarkSvg({ idPrefix, tile = false }) {
  ...
  return (
    <svg viewBox="0 0 112 112" aria-hidden="true" focusable="false">
      <defs>
        <linearGradient id={tileGradient} x1="18" y1="10" x2="95" y2="105" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FFFFFF" />
          <stop offset="0.55" stopColor="#F4FAFF" />
          <stop offset="1" stopColor="#E7F1FF" />
        </linearGradient>
        <linearGradient id={tileStroke} x1="18" y1="9" x2="100" y2="101" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FFFFFF" />
          <stop offset="0.42" stopColor="#CFE8FF" />
          <stop offset="1" stopColor="#A8C6FF" />
        </linearGradient>
        <linearGradient id={topFacet} x1="21" y1="19" x2="87" y2="52" gradientUnits="userSpaceOnUse">
          <stop stopColor="#5DE5FF" />
          <stop offset="0.48" stopColor="#3A8CFF" />
          <stop offset="1" stopColor="#2042E7" />
        </linearGradient>
        <linearGradient id={leftFacet} x1="16" y1="43" x2="51" y2="95" gradientUnits="userSpaceOnUse">
          <stop stopColor="#4BD7FF" />
          <stop offset="0.58" stopColor="#357BFF" />
          <stop offset="1" stopColor="#244CE3" />
        </linearGradient>
        <linearGradient id={rightFacet} x1="58" y1="43" x2="93" y2="96" gradientUnits="userSpaceOnUse">
          <stop stopColor="#67B7FF" />
          <stop offset="0.48" stopColor="#315CF4" />
          <stop offset="1" stopColor="#1621A8" />
        </linearGradient>
        <linearGradient id={lowerFacet} x1="39" y1="66" x2="73" y2="101" gradientUnits="userSpaceOnUse">
      ...
      {tile ? (
        <>
          ...
          <rect x="8.8" y="8.8" width="94.4" height="94.4" rx="24.2" fill="none" stroke={`url(#${tileStroke})`} strokeWidth="1.6" />
        </>
      ) : null}

      <g filter={`url(#${bevel})`}>
        <path d="M56 12.5 94 34.2 70.2 48.1 56 40.4 41.8 48.1 18 34.2Z" fill={`url(#${topFacet})`} />
        ...
        <path d="M42.7 57 56 64.5 69.3 57 69.3 91.2 56 99 42.7 91.2Z" fill={`url(#${lowerFacet})`} />
        <path d="M56 42.8 69.3 50.4 69.3 65.4 56 73.2 42.7 65.4 42.7 50.4Z" fill="rgba(255,255,255,0.96)" />
        <path d="M23.2 37.3 42.2 48.4M88.8 37.3 69.8 48.4M40.8 91.8 40.8 58.4M71.2 91.8 71.2 58.4" fill="none" stroke="rgba(255,255,255,0.34)" strokeWidth="1.4" strokeLinecap="round" />
      </g>

      <g filter={`url(#${blueGlow})`}>
        <circle cx="56" cy="61.2" r="19" fill={`url(#${coreGlow})`} />
        <path d="M56 29.6v18.6M32.4 76.5l16.4-9.8M79.6 76.5l-16.4-9.8M39.1 34.3l9.7 16.1M72.9 34.3l-9.7 16.1" fill="none" stroke="#FFFFFF" strokeWidth="5.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M56 61.2 56 48.2M56 61.2 48.8 50.4M56 61.2 63.2 50.4M56 61.2 32.4 76.5M56 61.2 79.6 76.5" fill="none" stroke="rgba(68,196,255,0.42)" strokeWidth="2" strokeLinecap="round" />
        ...
        <circle cx="56" cy="61.2" r="13.5" fill="none" stroke="rgba(114,235,255,0.6)" strokeWidth="1.1" />
      </g>
    </svg>
  );
}
    ...
    return (
      <span className={className} aria-label={`${title} PC Life Assistant`} role="img">
        <svg viewBox="0 0 520 132" aria-hidden="true" focusable="false">
          <defs>
            <linearGradient id={wordGradient} x1="150" y1="28" x2="474" y2="72" gradientUnits="userSpaceOnUse">
              <stop stopColor="#061935" />
              <stop offset="0.65" stopColor="#06142A" />
              <stop offset="1" stopColor="#0B2344" />
            </linearGradient>
            <linearGradient id={xGradient} x1="286" y1="28" x2="352" y2="82" gradientUnits="userSpaceOnUse">
          ...
          <text x="142" y="75" fill={`url(#${wordGradient})`} fontFamily="Orbitron, Rajdhani, Segoe UI, Arial, sans-serif" fontSize="58" fontWeight="900" letterSpacing="3">
            NE
          </text>
          <text x="275" y="75" fill={`url(#${xGradient})`} fontFamily="Orbitron, Rajdhani, Segoe UI, Arial, sans-serif" fontSize="58" fontWeight="900" letterSpacing="1">
            X
          </text>
          <text x="334" y="75" fill={`url(#${wordGradient})`} fontFamily="Orbitron, Rajdhani, Segoe UI, Arial, sans-serif" fontSize="58" fontWeight="900" letterSpacing="3">
            US
          </text>
          <text x="146" y="112" fill="#7C889A" fontFamily="Segoe UI, Arial, sans-serif" fontSize="18" fontWeight="600" letterSpacing="11">
            PC Life Assistant
          </text>
        </svg>
      </span>
